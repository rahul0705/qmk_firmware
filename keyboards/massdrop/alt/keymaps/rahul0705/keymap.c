 ...
 */
    [_FUNC] = LAYOUT(
        ...
        KC_TRNS,  RGB_SPD,  RGB_VAI,  RGB_SPI,  RGB_HUI,  RGB_SAI,  KC_TRNS,  U_T_AUTO, U_T_AGCR, KC_TRNS,  KC_PSCR,  KC_SLCK,  KC_PAUS,  TO(_EMJI),KC_END,  \
 ...
 */
    [_EMJI] = LAYOUT(
        TO(_BASE),ANGRY,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS, \
